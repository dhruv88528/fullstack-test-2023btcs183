      ...
      <section className='pt-12 bg-gray-50 sm:pt-16'>
        <div className='px-4 mx-auto max-w-7xl sm:px-6 lg:px-8'>
            <div className='max-w-2xl mx-auto text-center'>
                ...
                <div className='px-8 sm:items-center sm:justify-center sm:space-x-5 sm:flex mt-9'>
                    <a
                    href='#'
                    title='#'
                 ...
                 <p className='mt-8 text-base text-gray-500 font-inter'>60 Days free trial- No credits card required</p>   
            </div>
        </div>
